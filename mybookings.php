...
$query = "SELECT * FROM bookings WHERE booking_user_id = ?";
      ...
      <div class="row">
          ...
          if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                  // Output booking details as cards with buttons
                  ?>
                  <div class="card">
                      <div class="card-body">
                          <h5 class="card-title">Booking: <?php echo htmlspecialchars($row["Booking_id"]); ?></h5>
                          <!-- Add a button to view booking details -->
                          <a href="view_booking.php?booking_id=<?php echo $row['Booking_id']; ?>" class="btn btn-primary">View Details</a>
                      </div>
