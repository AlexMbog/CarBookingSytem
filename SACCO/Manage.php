...
<h2 class="mb-2">SACCO Dashboard</h2>
...
<div class="card">
    <div class="card-header">
        Drivers
        <a href="display_drivers.php" class="btn btn-primary float-right">View All</a>
        <a href="add_infor.php" class="btn btn-success float-right mr-2">Add Driver</a>
    </div>
   
    <div class="card-body">
        <?php include 'display_info.php'; ?>
    </div>
</div>
